...
#
# Generated by Vivado on Sun Apr 14 22:22:36 -0700 2024
...
set_property -name "compxlib.activehdl_compiled_library_dir" -value "$proj_dir/serial_ex.cache/compile_simlib/activehdl" -objects $obj
set_property -name "compxlib.funcsim" -value "1" -objects $obj
set_property -name "compxlib.ies_compiled_library_dir" -value "$proj_dir/serial_ex.cache/compile_simlib/ies" -objects $obj
set_property -name "compxlib.modelsim_compiled_library_dir" -value "$proj_dir/serial_ex.cache/compile_simlib/modelsim" -objects $obj
set_property -name "compxlib.overwrite_libs" -value "0" -objects $obj
set_property -name "compxlib.questa_compiled_library_dir" -value "$proj_dir/serial_ex.cache/compile_simlib/questa" -objects $obj
set_property -name "compxlib.riviera_compiled_library_dir" -value "$proj_dir/serial_ex.cache/compile_simlib/riviera" -objects $obj
set_property -name "compxlib.timesim" -value "1" -objects $obj
set_property -name "compxlib.vcs_compiled_library_dir" -value "$proj_dir/serial_ex.cache/compile_simlib/vcs" -objects $obj
...
set file "$origin_dir/proj_srcs/hdl/uart_tx.v"
